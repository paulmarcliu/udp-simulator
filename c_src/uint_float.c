...
#define S_FUNCTION_NAME uint_float
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
#define INPUT_0_DTYPE       SS_UINT32
...
#define OUTPUT_0_DTYPE       SS_SINGLE
...
static float AssembleFloat(uint32_T Val)
{
